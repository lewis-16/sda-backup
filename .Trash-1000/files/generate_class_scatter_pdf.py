#!/usr/bin/env python3
"""
为每个class_name生成一页散点图的PDF文件
每个页面显示该类别的高亮点和所有其他类别的浅灰色点
"""
...
def generate_class_scatter_pdf():
    """
    生成包含每个class_name散点图的PDF文件
    """
    # 读取数据
    print("正在读取数据...")
    ...
    # 创建PDF文件
    output_path = "/media/ubuntu/sda/visual_stimuli_pattern/dynamic/class_scatter_plots.pdf"
