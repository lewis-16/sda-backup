...
Modified code from the original [MindEyeV2 repository](https://github.com/MedARC-AI/MindEyeV2). The original repository is a PyTorch implementation of the MindEye2 method introduced in [MindEye2: Shared-Subject Models Enable fMRI-To-Image With 1 Hour of Data](https://arxiv.org/abs/2403.11207). Full citation below.
