...
import os
torch.set_num_threads(5)  # 限制 PyTorch 使用的 CPU 线程数
...
file = 'Neuronexus_32_20_recording'
...
with open(f"/media/ubuntu/sda/Spike_Sorting/paper_architecture/02_simulation_data/01_Neuroxenus_32_channels/spike_classification/eval_results/setting_2/{file}_accuracy.pkl", 'wb') as f:
