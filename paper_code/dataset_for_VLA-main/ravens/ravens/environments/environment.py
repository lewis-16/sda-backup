...
class Environment(gym.Env):
  ...
  def __init__(self,
    ...
    self._step_frame_callback = None
  ...
  def movej(self, targj, speed=0.01, timeout=60):
    ...
    while (time.time() - t0) < timeout:
      ...
      p.stepSimulation()
      sim_step += 1
      if sim_step % 16 == 0 and self._step_frame_callback is not None:
        self._step_frame_callback(self._get_obs())
