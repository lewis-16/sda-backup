...
class Args(Tap):
    data_path: str = '/share/project/public_datasets/public_natural_images/ImageNet/ImageNet1K'
    exp_name: str = 'text'
    labram_ckpt: str = ''
    sub: str = 'sub-08'
    ...
    pixcorr: float = None      # [automatically set; don't specify this]
