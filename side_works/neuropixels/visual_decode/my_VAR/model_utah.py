...
def create_integrated_datasets(firing_rate_path=None, csv_path=None,
                             test_size=0.2, random_state=42, train = True):
    
    neuro_data, labels = load_firing_rate_data(firing_rate_path, train=train)
...
firing_rate_path = "/disk1/jinchentao/visual_decode/visual_reconstruction/my_VAR_new/firing_rate_summary_0112.pkl"
csv_path = "/disk1/jinchentao/visual_decode/monkey/test_image.csv"
